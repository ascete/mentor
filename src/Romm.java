public enum Romm {
    I(1), II(2), III(3),IV(4), V(5),VI(6), VII(7),
            ...
            LXXXI(81), LXXXII(82), LXXXIII(83), LXXXIV(84), LXXXV(85), LXXXVI(86),
            LXXXVII(87), LXXXVIII(88), LXXXIX(89), XC(90), XCI(91), XCII(92),
            XCIII(93), XCIV(94), XCV(95), XCVI(96), XCVII(97), XCVIII(98),
            XCIX(99), C(100);

    //лишнего зделал, переводим результат из арабских цифр в римские
